...
function ProjectCard(props: Props) {
    return (
        <div className="flex flex-col border-4 border-white bg-slate-900 rounded-xl text-white p-4 m-6 hover:scale-105 transition delay-100 duration-300 items-center">
