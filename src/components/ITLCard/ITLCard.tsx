...
function ITLCard(props: Props) {
    return (
        <div className="flex justify-center border-4 border-white flex-col bg-slate-900 2xl:w-1/4 w-4/5 md:w-2/5 h-1/2 rounded-xl m-4 hover:scale-105 transition delay-100 duration-300 p-4">
