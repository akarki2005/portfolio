...
function ResumePage() {
    return (
        ...
        <div className="flex flex-row w-4/5 lg:w-full justify-center justify-self-center">
            <ImageCard imgurl="./assets/images/resume.png" linkurl={"/src/assets/files/AayushKarki_Resume.pdf"}></ImageCard>
        </div>
